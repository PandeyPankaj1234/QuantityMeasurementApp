...
public class Quantity<U extends IMeasurable> {
    ...
    public Quantity<U> add(Quantity<U> other, U targetUnit) {
        ...
        return new Quantity<>(targetUnit.convertFromBaseUnit(performBaseArithmetic(other, ArithmeticOperation.ADD)),
                targetUnit);
    }
    ...
    public Quantity<U> subtract(Quantity<U> other, U targetUnit) {
        validateArithmeticOperands(other, targetUnit, true);
        return new Quantity<>(
                targetUnit.convertFromBaseUnit(performBaseArithmetic(other, ArithmeticOperation.SUBTRACT)), targetUnit);
    }
